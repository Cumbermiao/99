      ...
      e['a'] = u({
        mixins: [
          Object(o['a'])(function (t) {
            this.scroller || (this.scroller = Object(i['d'])(this.$el)),
          ...
          check: function () {
            ...
            this.$nextTick(function () {
              if (!(t.innerLoading || t.finished || t.error)) {
                ...
                ;(s =
                  'up' === o ? e.top - u.top <= i : u.bottom - e.bottom <= i),
                  s &&
                    ((t.innerLoading = !0),
                    t.$emit('input', !0),
                    t.$emit('load'))
        ...
        return [
          ...
          function (t) {
            ...
            while (null !== (f = s(o, u))) {
              var h = String(f[0])
              ;(l[p] = h),
                '' === h && (o.lastIndex = c(u, i(o.lastIndex), d)),
                p++
            }
            return 0 === p ? null : l
          },
    ...
    '4df4': function (t, e, r) {
      ...
      t.exports = function (t) {
        var e,
          ...
          A = 0
        if (
          (b && (m = n(m, v > 2 ? arguments[2] : void 0, 2)),
          void 0 == y || (g == Array && o(y)))
        )
          for (e = c(h.length), r = new g(e); e > A; A++)
            (p = b ? m(h[A], A) : h[A]), s(r, A, p)
        else
          for (
            f = y.call(h), l = f.next, r = new g();
            !(d = l.call(f)).done;
            A++
          )
            (p = b ? i(f, m, [d.value, A], !0) : d.value), s(r, A, p)
        return (r.length = A), r
      }
    },
          ...
          splice: function (t, e) {
            ...
            if (
              (0 === O
                ...
                : 1 === O
                ? ((r = 0), (n = y - A))
                : ((r = O - 2), (n = p(l(i(e), 0), y - A))),
              y + r - n > h)
            )
              throw TypeError(g)
            for (d = s(b, n), f = 0; f < n; f++)
              (v = A + f), v in b && u(d, f, b[v])
            if (((d.length = n), r < n)) {
              for (f = A; f < y - n; f++)
                (v = f + n), (m = f + r), v in b ? (b[m] = b[v]) : delete b[m]
              for (f = y; f > y - n + r; f--) delete b[f - 1]
            } else if (r > n)
              for (f = y - n; f > A; f--)
                (v = f + n - 1),
                  (m = f + r - 1),
                  v in b ? (b[m] = b[v]) : delete b[m]
    ...
    a4d3: function (t, e, r) {
      ...
      var n = r('23e7'),
        ...
        ft = function (t) {
          ...
          return (
            !(this === W && f(Z, e) && !f(q, e)) &&
            (!(r || !f(this, e) || !f(Z, e) || (f(this, N) && this[N][e])) || r)
          )
        },
        lt = function (t, e) {
          var r = v(t),
          ...
          if (r !== W || !f(Z, n) || f(q, n)) {
            var a = F(r, n)
            return (
              !a || !f(Z, n) || (f(r, N) && r[N][n]) || (a.enumerable = !0), a
            )
          }
        },
        pt = function (t) {
      ...
      var n = function () {
              ...
              n(
                ...
                [
                  n(
                    ...
                    [
                      t._v('今日已做任务'),
                      n('span', [t._v(' ' + t._s(t.todayAreaTaskCount) + ' ')]),
                      t._v('次；累计已完成订单'),
                      n('span', [
                        t._v(' ' + t._s(t.totalAreaOrderWinningCount) + ' '),
                      ]),
                      t._v('条'),
                    ]
                  ),
                        ...
                        n(
                          ...
                          [
                            n(
                              ...
                              [t._v(t._s(e.PriceAreaName) + '专区')]
                            ),
                            n('img', {
                              staticClass: 'img',
                              attrs: {
                                src: e.ProductMainImage
                                  ? e.ProductMainImage + '!100r70'
                                  : '',
                                mode: '',
                              },
                            }),
        ...
        h = {
          ...
          created: function () {
            ...
            ;(this.manyPGLotteryStatus = t.type),
              (this.title = t.title),
              this.reKey && ((this.areaId = t.areaId), this.setReKey(!1)),
              'true' == localStorage.getItem('gameKey')
                ? (localStorage.setItem('gameKey', !1),
                  this.$router.push('/game'),
                  (this.gameKey = !1))
                : 0 === this.teamList.length
                ? this.getList2()
                : this.getList(!0)
          },
          computed: Object(c['a'])(
            {},
            Object(p['c'])('newGroup', ['priceAreaId', 'reKey'])
          ),
          activated: function () {
          ...
          mounted: function () {
            ;(this.u =
              window.webkit && window.webkit.messageHandlers.onItemClick),
          ...
          methods: Object(c['a'])(
            ...
            {},
            {
                        ...
                        switch ((r.prev = r.next)) {
                          case 0:
                            return (
                              (r.next = 2),
                              e.$http.post(
                                '/api/v3/ManyPGProduct/GetToDateTaskNum',
                                {
                                  priceAreaId: t,
                                },
                                {
                          ...
                          case 2:
                            ;(n = r.sent),
                              ...
                              1 === a.code &&
                                (u['a'].clear(),
                                (e.todayAreaTaskCount =
                                  a.data.todayAreaTaskCount),
                                (e.totalAreaOrderWinningCount =
                                  a.data.totalAreaOrderWinningCount))
                          case 5:
                          case 'end':
                            return r.stop()
                        }
                          ...
                          case 2:
                            ;(r = e.sent),
                              ...
                              1 === n.code &&
                                ...
                                (t.teamList = n.data),
                                (t.areaId =
                                  t.areaId || t.priceAreaId
                                    ? t.areaId || t.priceAreaId
                                    : n.data[0].priceAreaId),
                                (t.pageIndex = 1),
                                (t.ajaxKey = !0),
                                t.getList(!0))
                          case 5:
                                        ...
                                        switch ((r.prev = r.next)) {
                                          case 0:
                                            return (
                                              (r.next = 2),
                                              e.$http.post(
                                                '/api/v3/ManyPGProduct/CancelOrder',
                                                {
                                                  orderId: t.OrderId,
                                                },
                                                {
              ...
              toGame: function (t) {
                ...
                var e = this
                /** start */
                e.setPrice(t.PriceAreaName)
                e.setPriceAreaId(t.PriceAreaId)
                e.PriceAreaName = t.PriceAreaName
                e.$http.post(
                  '/api/v3/ManyPGTask/StartAdvTask',
                  {
                    orderId: t.OrderId,
                  },
                  {
                  ...
                  const data = res.data
                  if(data.code ===1){
                    e.setTaskToken(data.data.taskToken)
                    e.advId = data.data.advData.advId
                    e.mchId = data.data.advData.mchId
                    e.taskToken = data.data.taskToken
                    e.$router.push('/game')
                  }else {
                    setTimeout(()=>{
                      if(e.list.length){
                ...
                //         });
                //       case 20:
                //         return s = r.sent, d = s.data, 1 === d.code ? (e.setTaskToken(d.data.taskToken), e.taskToken = d.data.taskToken, e.$router.push("/game")) : e.toGameKey = !1, r.abrupt("return", !1);
                //       case 24:
                //         return u["a"].loading({
                //           duration: 0,
                //           message: "正在请求任务...",
              ...
              scrollChange: function () {
                this.ajaxKey &&
                  1 !== this.pageIndex &&
                  (this.pageIndex++, this.getList(!1, 1))
              },
              getList: function () {
                var t = this,
                  e =
                              ...
                              switch ((r.prev = r.next)) {
                                case 0:
                                  return (
                                    (r.next = 2),
                                    t.$http.post(
                                      '/api/v3/ManyPGProduct/GetManyOrderList',
                                      {
                                        manyPGLotteryStatus:
                                          t.manyPGLotteryStatus,
                                        pageSize: t.PageSize,
                                ...
                                case 2:
                                  ...
                                  if (
                                    (t.getToDateTaskNum(t.areaId),
                                    (t.activeId = t.areaId),
                                    u['a'].clear(),
                                    e
                                      ? ((c = t.list.length),
                                        (o = t.list).splice.apply(
                                          o,
                                          [0, c].concat(Object(i['a'])(a.data))
                                        ))
                                      : (t.list = t.list.concat(a.data)),
                                    0 !== a.data.length)
                                  ) {
                                    r.next = 13
                                    break
          ...
          slice: function (t, e) {
            ...
            if (
              ...
              'function' != typeof r || (r !== Array && !i(r.prototype))
                ? a(r) && ((r = r[p]), null === r && (r = void 0))
                : (r = void 0),
              r === Array || void 0 === r)
            )
              return h.call(f, v, m)
            for (
              n = new (void 0 === r ? Array : r)(g(m - v, 0)), d = 0;
              v < m;
              v++, d++
            )
              v in f && u(n, d, f[v])
