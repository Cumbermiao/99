    ...
    <div class="address-list">
      <div class="a-address" v-for="(item,index) in addressList" :key="index">
        <div class="left-text" :class="item.IsDefault ? 'active' : ''" @click="xuanze(item)">
          ...
          <div v-if="item.Tag" class="tagBox">
            {{item.Tag}}
          </div>
        </div>
        <div class="right-del" @tap="delAddess(item.AddressId)"></div><strong></strong>
        <div class="right-edit" @tap="editAddess(item.AddressId)"></div>
      </div>
    </div>
    <!-- 	<div class="bottom-box">
			<div class="add-btn" @tap="addAddess">新增收货地址</div>
		</div> -->
  ...
  export default {
    ...
    created() {
      ...
      this.$store.commit('navTop/setRightUrl',{
        rightUrl: '/groupworkdetails/address?ProductId=' + this.ProductId + '&OrderId=' + this.OrderId + '&type=xuan' + '&pirceTitle=' + this.pirceTitle + '&priceAreaId=' + this.priceAreaId
      })
    },
    onBackPress() {
      this.$router.push('/groupworkdetails/selectNow?ProductId=' + this.ProductId + '&OrderId=' + this.OrderId +
    ...
    methods: {
      ...
      editAddess(id) {
        this.$router.push('/groupworkdetails/address?id=' + id + '&ProductId=' + this.ProductId + '&OrderId=' + this
