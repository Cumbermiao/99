...
<script>
  ...
  export default {
    ...
    onNavigationBarButtonTap() {
      this.$router.push('/groupworkdetails/returnAddress?pid=' + this.pid + '&PriceAreaId=' + this.PriceAreaId +
        '&Price=' + this.Price)
    },
    created() {
    ...
    onBackPress() {
      this.$router.push('/groupworkdetails/returnSelectNow?pid=' + this.pid + '&PriceAreaId=' + this.PriceAreaId +
        '&Price=' + this.Price)
      return true
    },
    mounted() {
    ...
    methods: {
      ...
      editAddess(id) {
        this.$router.push('/groupworkdetails/returnAddress?id=' + id + '&pid=' + this.pid + '&PriceAreaId=' + this
