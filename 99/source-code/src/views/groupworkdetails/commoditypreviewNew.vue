<template>
  <div class="commoditypreview">
    <navigator v-for="(item,index) in commodityList" :key="index"
      :url="'./commodittypepreviewDeatilsNew?pid=' + item.ProductId + '&PriceAreaId=' + PriceAreaId + '&Price=' + Price"
      hover-class="none">
...
import { Toast } from 'vant'
  ...
  export default {
    ...
    onBackPress() {
      this.$router.push('/groupworkdetails?&PriceAreaId=' + this.PriceAreaId + '&Price=' + this.Price)
      return true
    },
    methods: {
      async getList() {
