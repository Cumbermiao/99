<template>
	<div class="commodittypepreviewDeatilsBox">
		...
		<div class="footerShop" v-if="xuanType === 'xuan'">
...
<script>
  ...
  import { Swipe, SwipeItem } from 'vant';
    ...
    components:{Swipe, SwipeItem},
		...
		onBackPress() {
			if (this.xuanType === 'xuan') {
        this.$router.push('/groupworkdetails/xuanzeshop?priceAreaId=' + this.priceAreaId + '&pirceTitle=' + this.pirceTitle + '&OrderId=' + this.OrderId)
				return true
			}
		},
		created() {
      let option = this.$route.query
		...
		methods: {
			...
			selectNow() {
        this.$router.push('/groupworkdetails/selectNow?priceAreaId=' + this.priceAreaId + '&pirceTitle=' + this.pirceTitle + '&OrderId=' + this.OrderId + '&ProductId=' + this.pid)
			}
		}
	}
</script>
