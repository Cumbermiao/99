...
<script>
  ...
  export default {
    ...
    onNavigationBarButtonTap() {
      this.$router.push('/groupworkdetails/newAddress?ProductId=' + this.ProductId + '&priceAreaId=' + this
    ...
    created() {
      ...
      this.$store.commit('navTop/setRightUrl',{
        rightUrl: '/groupworkdetails/newAddress?ProductId=' + this.ProductId  + '&priceAreaId=' + this.priceAreaId + '&Price=' + this.Price
      })
    },
    // onBackPress() {
    //   this.$router.push('/groupworkdetails/newSelectNow?ProductId=' + this.ProductId + '&priceAreaId=' + this
    //     .priceAreaId + '&Price=' + this.Price)
    //   return true
    // },
    mounted() {
    ...
    methods: {
      ...
      editAddess(id) {
        this.$router.push('/groupworkdetails/newAddress?id=' + id + '&ProductId=' + this.ProductId + '&OrderId=' + this
