<template>
	<div class="container999">
        ...
        <field class="input" placeholder-class="plaClass" placeholder="请输入姓名" v-model="name"></field>
			</div>
		</div>
		<div class='line'>
			<div class='lineLeft'>手机号码</div>
			<div class="lineRight">
        <field class="input" type="number" :maxlength='11' placeholder-class="plaClass" placeholder="请输入手机号" v-model="phone"></field>
			</div>
		</div>
		<div class='line'>
		...
		<div class='line textarea'>
			...
			<div class="lineRight">
        <field class="input" style="padding:0" type="textarea"  maxlength="64" placeholder-class="plaClass" placeholder="请输入详细地址" v-model="detailsAddress"></field>
			</div>
		...
		<div class='line'>
			...
			<div class="lineRight">
        <v-switch v-model="defaultAddressRadio" active-color="#1BC31F" style="transform:scale(0.7);position: absolute;right: 0"/>
			</div>
		</div>
...
<script>
  ...
  Switch as vSwitch
	...
	export default {
		components: {"lotus-address": lotusAddress,Field,vSwitch},
		data() {
			return {
