<template>
  <div class="container">
    <div class="address-list">
      <div class="a-address" :class="item.IsDefault ? 'active' : ''" v-for="(item,index) in addressList" :key="index">
        <div class="left-text" @click="selectTap(item.AddressId,index)">
          <div class="name-tel">
...
<script>
  ...
  export default {
    ...
    onNavigationBarButtonTap() {
      this.$router.push('/addressmanagement/addandeditaddress')
    },
    onBackPress() {
    ...
    created(){
      this.$store.commit('navTop/setRightUrl',{
        rightUrl: '/addressmanagement/addandeditaddress'
      })
    },
    mounted() {
      this.getAddress()
    ...
    methods: {
      ...
      selectTap() {},
      editAddess(id) {
        console.log('editAddess');
        this.$router.push('/addressmanagement/addandeditaddress?id=' + id)
      },
      // 删除地址
      delAddess(id) {
        Dialog.confirm({
