<template>
  <div class="container999">
    ...
    <div class='line'>
      ...
      <div class="lineRight">
        <input class="input" v-model="phone" type="number" placeholder-class="plaClass" placeholder='请输入手机号'>
      </div>
    </div>
    <div class='line'>
    ...
    <div class='line textarea'>
      ...
      <div class="lineRight">
        <textarea class="input textareaInput" @input="change" v-model="detailsAddress" maxlength="64" data-name="remarks"
          placeholder-class="plaClass" placeholder='请输入详细地址'></textarea>
      </div>
    ...
    <div class='line'>
      ...
      <div class="lineRight" v-for="(item,index) in defaultAddress" :key="index" @click="checkedItem(index,item)">
    ...
    <div class='line'>
      ...
      <div class="lineRight">
        <v-switch v-model="defaultAddressRadio" active-color="#1BC31F"
          style="transform:scale(0.7);position: absolute;right: 0" />
      </div>
    </div>
...
<script>
  ...
  // import counties from '../../util/counties.js'
  ...
  export default {
    ...
    watch:{
      phone(value){
        let str = value+''
        if(str.length > 11){
          this.phone = Number(str.substring(0,11))
        }else if(str === '0'){
          this.phone = null
        }else{
      ...
      submit: util.throttle(async function () {
        ...
        if (this.addressDio) {
          ...
          obj = {
            ...
            IsDefault: that.defaultAddressRadio || false
          }
        } else {
...
<style lang="less" scoped>
  ...
  .container999 {
    ...
    .line {
      ...
      .active {
        background: linear-gradient(to right, #FB6463, #FB8663);
        color: #fff;
        border: none;
      }
