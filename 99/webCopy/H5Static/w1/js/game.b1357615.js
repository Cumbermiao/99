    ...
    "3b6a": function (t, e, r) {
      ...
      var n = function () {
        ...
        l = {
          ...
          mounted: function () {
            this.list2 = this.list1.map(function (t) {
              return t.priceAreaId;
            });
          },
          destroyed: function () {
                    ...
                    return regeneratorRuntime.wrap(function (e) {
                      while (1)
                        switch ((e.prev = e.next)) {
                          case 0:
                            (r = new Date()),
                              (t.gameStyle.transform = "rotate(-2160deg)"),
                              (t.gameStyle.transition = "15s"),
                              setTimeout(
                                Object(a["a"])(
                                  regeneratorRuntime.mark(function e() {
                                    var n, i, a, o, c, s, f, l, d, g;
                                        ...
                                        switch ((e.prev = e.next)) {
                                          case 0:
                                            return (
                                              (e.next = 2),
                                              t.$http.post(
                                                "/api/v3/ManyPGTask/FinishAdvTask",
                                                { data: t.taskToken },
                                                {
                                                  custom: {
                                                    url: "99",
